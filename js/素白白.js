...
var rule = {
    ...
    class_name: '国产剧&电视剧&动漫电影&欧美剧&韩剧&动漫剧&漫威宇宙电影系列&速度与激情电影系列&007系列(25部正传+2部外传)',//静态分类名称拼接
    class_url: 'domestic-drama&tv-drama&cartoon-movie&american-drama&korean-drama&anime-drama&marvel-movies&fastfurious&zero-zero-seven',//静态分类标识拼接
    play_parse: true,
    lazy: $js.toString(() => {
        pdfh = jsp.pdfh;
